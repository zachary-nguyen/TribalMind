...
def watch_add(
    ...
    console.print("[dim]Restart the daemon for changes to take effect: tribal stop && tribal start[/dim]")
...
def watch_list() -> None:
    ...
    if not settings.watch_dirs:
        console.print("[yellow]No directories configured — daemon is not monitoring any commands.[/yellow]")
